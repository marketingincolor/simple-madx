...
var apiRoot = exports.apiRoot = location.origin + '/wp-json/wp/v2/';
var acfApiRoot = exports.acfApiRoot = location.origin + '/wp-json/acf/v3/';
...
exports.default = {
	...
	methods: {
		...
		zipCodeLookup: function zipCodeLookup() {
		...
		getPosition: function getPosition(position) {
			var $this = this;
			var apiURL = 'https://maps.googleapis.com/maps/api/geocode/json?latlng=' + position.coords.latitude + ',' + position.coords.longitude + '&key=' + this.googleKey;

			axios.get(apiURL).then(function (response) {
				$this.zipCode = response.data.results[0].address_components[7].long_name;
				var form = document.forms['zip-form'];
		...
		getGoogleApiKey: function getGoogleApiKey() {
			...
			axios.get('/google-api-key.php').then(function (response) {
				$this.googleKey = response.data;
			});
		},
		sendZip: function sendZip(zip) {
			var $this = this;
...
var _autoPosts = __webpack_require__(41);

var _autoPosts2 = _interopRequireDefault(_autoPosts);

var _safetyFilmTypes = __webpack_require__(42);

var _safetyFilmTypes2 = _interopRequireDefault(_safetyFilmTypes);

var _taxTermPosts = __webpack_require__(43);

var _taxTermPosts2 = _interopRequireDefault(_taxTermPosts);

var _findDealerForm = __webpack_require__(12);

var _findDealerForm2 = _interopRequireDefault(_findDealerForm);

var _findDealerPage = __webpack_require__(44);

var _findDealerPage2 = _interopRequireDefault(_findDealerPage);

var _filmSelector = __webpack_require__(45);

var _filmSelector2 = _interopRequireDefault(_filmSelector);

var _safetyPosts = __webpack_require__(46);

var _safetyPosts2 = _interopRequireDefault(_safetyPosts);

var _specialtyIndustries = __webpack_require__(47);

var _specialtyIndustries2 = _interopRequireDefault(_specialtyIndustries);

var _caseStudies = __webpack_require__(48);

var _caseStudies2 = _interopRequireDefault(_caseStudies);

var _decorativePosts = __webpack_require__(49);

var _decorativePosts2 = _interopRequireDefault(_decorativePosts);

var _specialtyProducts = __webpack_require__(50);

var _specialtyProducts2 = _interopRequireDefault(_specialtyProducts);

var _specialtyProductsHome = __webpack_require__(51);

var _specialtyProductsHome2 = _interopRequireDefault(_specialtyProductsHome);

var _findDealerModal = __webpack_require__(52);

var _findDealerModal2 = _interopRequireDefault(_findDealerModal);

var _faqs = __webpack_require__(53);

var _faqs2 = _interopRequireDefault(_faqs);

var _taxonomyFaqs = __webpack_require__(54);

var _taxonomyFaqs2 = _interopRequireDefault(_taxonomyFaqs);

var _residentialFilmSelector = __webpack_require__(55);

var _residentialFilmSelector2 = _interopRequireDefault(_residentialFilmSelector);

var _maduVideoModal = __webpack_require__(56);

var _maduVideoModal2 = _interopRequireDefault(_maduVideoModal);

var _jotForm = __webpack_require__(57);
...
Vue.directive('dropdown', {
  bind: function bind(el) {
    new _foundationSites2.default.DropdownMenu((0, _jquery2.default)(el));
  }
});
...
Vue.directive('drop-click', {
  bind: function bind(el) {
    new _foundationSites2.default.Dropdown((0, _jquery2.default)(el));
  }
});
...
Vue.directive('slider', {
  bind: function bind(el) {
    new _foundationSites2.default.Slider((0, _jquery2.default)(el));
  }
});
...
Vue.directive('f-orbit', {
  bind: function bind(el) {
    new _foundationSites2.default.Orbit((0, _jquery2.default)(el));
  },
  unbind: function unbind(el) {
    (0, _jquery2.default)(el).foundation.destroy();
  }
});
...
Vue.directive('reveal', {
  bind: function bind(el) {
    new _foundationSites2.default.Reveal((0, _jquery2.default)(el));
  }
});
...
Vue.directive('accordion', {
  bind: function bind(el) {
    new _foundationSites2.default.Accordion((0, _jquery2.default)(el));
  }
});
...
Vue.directive('tabs', {
  bind: function bind(el) {
    new _foundationSites2.default.Tabs((0, _jquery2.default)(el));
  }
});
...
Vue.directive('tooltip', {
  bind: function bind(el) {
    new _foundationSites2.default.Tooltip((0, _jquery2.default)(el));
  }
});
...
var newVue = new Vue({
  el: '#app',
  components: {
    'auto-posts': _autoPosts2.default,
    'safety-film-types': _safetyFilmTypes2.default,
    'tax-term-posts': _taxTermPosts2.default,
    'find-dealer-form': _findDealerForm2.default,
    'film-selector': _filmSelector2.default,
    'safety-posts': _safetyPosts2.default,
    'specialty-industries': _specialtyIndustries2.default,
    'case-studies': _caseStudies2.default,
    'decorative-posts': _decorativePosts2.default,
    'specialty-products': _specialtyProducts2.default,
    'specialty-products-home': _specialtyProductsHome2.default,
    'find-dealer-page': _findDealerPage2.default,
    'find-dealer-modal': _findDealerModal2.default,
    'faqs': _faqs2.default,
    'taxonomy-faqs': _taxonomyFaqs2.default,
    'residential-film-selector': _residentialFilmSelector2.default,
    'madu-video-modal': _maduVideoModal2.default,
    'jot-form': _jotForm2.default
  },
  created: function created() {
  ...
  methods: {
    closeMobileMenuOutside: function closeMobileMenuOutside() {
      var $this = this;
      (0, _jquery2.default)('section').on('click', function () {
        $this.mobileLeftMenuClose();
      });
    },
    mobileLeftMenuOpen: function mobileLeftMenuOpen() {
      var menu = document.getElementById('mobile-left-menu');
      var body = document.getElementsByTagName('body')[0];

      menu.classList.add('mobile-menu-open');
      body.classList.add('no-scroll');
    },
    mobileLeftMenuClose: function mobileLeftMenuClose() {
      var menu = document.getElementById('mobile-left-menu');
      var body = document.getElementsByTagName('body')[0];
    ...
    mobileMenuSearch: function mobileMenuSearch() {
      // Toggle between search icon and X icon in mobile header
      var searchToggle = document.getElementById('search-toggle');
      var searchIcon = searchToggle.querySelector('.fa-search');
      var exitIcon = searchToggle.querySelector('.fa-times');
    ...
    protectionProCarousel: function protectionProCarousel() {
      (0, _jquery2.default)('.full-body-carousel').owlCarousel({
        items: 1,
        loop: false,
        center: true,
        margin: 0,
      ...
      (0, _jquery2.default)('.orbit-slide').find('a').on('click', function () {
        (0, _jquery2.default)('.orbit-slide').find('img').removeClass('active-swatch');
        (0, _jquery2.default)(this).find('img').addClass('active-swatch');
      });
    },
    openDistributionTab: function openDistributionTab(event) {
      var id;
      if (event.target.nodeName.toLowerCase() == "a") {
        ...
        id = (0, _jquery2.default)('select.is-active').find('option:selected').val();
        console.log(id);
      }
      (0, _jquery2.default)(event.target).addClass('is-active');
      (0, _jquery2.default)('#tabs-content').find('.tabs-panel').removeClass('is-active');
      (0, _jquery2.default)(id).addClass('is-active');
    },
    openProductTab: function openProductTab(event) {
      var id = (0, _jquery2.default)('#product-list').find('option:selected').val();
      console.log(id);

      (0, _jquery2.default)('#tabs-content').find('.tabs-panel').removeClass('is-active');
      (0, _jquery2.default)(id).addClass('is-active');
    },
    runIEpolyfills: function runIEpolyfills() {
    ...
    menuDropdown: function menuDropdown() {
      ...
      (0, _jquery2.default)(".dropdown").on('show.zf.dropdownmenu', function (ev, $el) {
        $el.css({ "display": "none" }).fadeIn(300);
      });

      (0, _jquery2.default)(".dropdown").on('hide.zf.dropdownmenu', function (ev, $el) {
        $el.children("ul").css('display', 'inherit').fadeOut(200);
      });
    }
  }
});
...
exports.default = {
	...
	methods: {
		getAutoPosts: function getAutoPosts() {
			var $this = this;

			axios.get(_config.apiRoot + $this.postType).then(function (response) {
		...
		getAutoPostSingle: function getAutoPostSingle(postSlug) {
			var $this = this;

			axios.get(_config.apiRoot + $this.postType + '?_embed&slug=' + postSlug).then(function (response) {
...
exports.default = {
	...
	methods: {
		getACFdata: function getACFdata() {
			var $this = this;

			axios
			// Get page ID in order to get ACF Data
			.get(_config.apiRoot + 'pages?slug=safety-security').then(function (response) {
				var pageID = response.data[0].id;

				axios.get(_config.acfApiRoot + 'pages/' + pageID).then(function (response) {
...
exports.default = {
	...
	methods: {
		getPostType: function getPostType(currentURL) {
		...
		getTaxParent: function getTaxParent(currentURL) {
		...
		getTaxParentId: function getTaxParentId() {
			var $this = this;

			axios.get(_config.apiRoot + $this.postType + '-categories').then(function (response) {
				for (var i = 0; i < response.data.length; i++) {
					if (response.data[i].link.includes($this.taxParentSlug)) {
		...
		getTaxonomies: function getTaxonomies() {
			...
			axios.get(_config.apiRoot + $this.postType + '-categories?parent=' + $this.taxParentId).then(function (response) {
				$this.taxonomies = response.data;
				$this.activeItem = $this.taxonomies[0].name;
				$this.getTaxPosts();
			});
		},
		getTaxPosts: function getTaxPosts() {
			var $this = this;
			var taxonomyName = $this.activeItem.toLowerCase().split(' ').join('-');

			axios.get(_config.apiRoot + $this.postType + '?_embed&filter[' + $this.postType + '_taxonomies]=' + taxonomyName).then(function (response) {
				$this.taxPosts = response.data;
				console.log(response.data);
				$this.singlePostActive = false;
			});
		},
		getNewTaxPosts: function getNewTaxPosts(event) {
			var $this = this;
			var taxonomyName = event.target.innerHTML.toLowerCase().split(' ').join('-');
		...
		getSinglePost: function getSinglePost(postID) {
			...
			axios.all([axios.get(_config.apiRoot + $this.postType + '/' + postID + '?_embed'), axios.get(_config.acfApiRoot + $this.postType + '/' + postID)]).then(axios.spread(function (postRes, acfRes) {
		...
		scrollToProducts: function scrollToProducts() {
			var $this = this;
...
exports.default = {
	...
	methods: {
		validateZip: function validateZip() {
			var form = document.forms['find-dealer-form'];
			var zip = form.querySelector("#zip");
...
exports.default = {
	...
	methods: {
		getCarSize: function getCarSize() {
		...
		getFilms: function getFilms() {
			...
			var heat = this.$options.filters.importance(this.heatReduction);
			var glare = this.$options.filters.importance(this.glareReduction);

			axios.get(_config.apiRoot + $this.postType + '?per_page=99').then(function (response) {
				$this.postData = [];
		...
		setModalContent: function setModalContent(postID) {
			var $this = this;
			axios.get(_config.apiRoot + 'automotive/' + postID + '?_embed').then(function (response) {
		...
		sendEmail: function sendEmail() {
			var link = "mailto:?subject=Madico%20Film%20Selector%20Results" + "&body=" + document.getElementsByClassName("post-container")[0].innerText;
...
exports.default = {
	...
	methods: {
		...
		getSafetyPosts: function getSafetyPosts() {
			var $this = this;
			...
			axios.get(_config.apiRoot + $this.postType).then(function (response) {
				...
				var slug = $this.safetyPosts[0].slug;
				$this.getSafetyPostSingle(slug);
			});
		},
		getSafetyPostSingle: function getSafetyPostSingle(postSlug) {
			var $this = this;
...
exports.default = {
	...
	methods: {
		...
		getTaxPosts: function getTaxPosts() {
			...
			axios.get(_config.apiRoot + $this.postType + '?_embed&orderby=menu_order&order=asc&filter[' + $this.postType + '_taxonomies]=' + $this.taxParentSlug).then(function (response) {
				$this.taxPosts = response.data;
				$this.singlePostActive = false;
			});
		},
		getNewTaxPosts: function getNewTaxPosts(event) {
			...
			axios.get(_config.apiRoot + $this.postType + '?_embed&orderby=menu_order&order=asc&filter[' + $this.postType + '_taxonomies]=' + taxonomyName).then(function (response) {
				$this.taxPosts = response.data;
				$this.activeItem = event.target.innerHTML;
				$this.singlePostActive = false;
			});
...
exports.default = {
	...
	methods: {
		...
		getTaxPosts: function getTaxPosts() {
			...
			axios.get(_config.apiRoot + $this.postType + '?_embed&filter[' + $this.postType + '_taxonomies]=' + $this.taxParentSlug).then(function (response) {
				$this.taxPosts = response.data;
				$this.singlePostActive = false;
			});
		},
...
exports.default = {
	...
	methods: {
		...
		getDecorativePosts: function getDecorativePosts() {
			var $this = this;
		...
		getDecorativePostSingle: function getDecorativePostSingle(postSlug) {
			var $this = this;
...
exports.default = {
	...
	methods: {
		...
		getTaxPosts: function getTaxPosts(description) {
			var $this = this;
			var taxonomyName = $this.activeItem.toLowerCase().split(' ').join('-');
		...
		getNewTaxPosts: function getNewTaxPosts(event) {
			var $this = this;
			var taxonomyName = event.target.innerHTML.toLowerCase().split(' ').join('-').replace(/<[^>]+>/g, '');

			axios.all([axios.get(_config.apiRoot + $this.postType + '?_embed&filter[' + $this.postType + '_taxonomies]=' + taxonomyName), axios.get(_config.apiRoot + $this.postType + '-categories?parent=' + $this.taxParentId)]).then(axios.spread(function (postRes, acfRes) {
				$this.taxPosts = postRes.data;
				$this.activeItem = event.target.innerHTML;
				acfRes.data.forEach(function (element) {
					if (element.name.replace(/®/g, '<sup>®</sup>') == $this.activeItem) $this.taxDescription = element.description;
				});
				$this.singlePostActive = false;
			}));
		},
		...
		replaceRegMark: function replaceRegMark() {
			var menuItems = document.getElementById('posts-container').querySelectorAll('li a,h4,span');
			for (var i = 0; i < menuItems.length; i++) {
				var str = menuItems[i].innerHTML;
...
exports.default = {
	...
	methods: {
		...
		queryLink: function queryLink() {
			location.href = '/specialty-solutions/products?product=' + this.queryString;
		},
		replaceRegMark: function replaceRegMark() {
			var menuItems = document.getElementById('posts-container').querySelectorAll('li a,h4');
			for (var i = 0; i < menuItems.length; i++) {
				var str = menuItems[i].innerHTML;
				menuItems[i].innerHTML = str.replace(/®/g, '<sup>®</sup>');
				menuItems[i].innerHTML = str.replace(/™/g, '<sup>™</sup>');
...
exports.default = {
	...
	methods: {
		getAllFAQs: function getAllFAQs() {
			var $this = this;
		...
		getCategories: function getCategories() {
			...
			axios.get(_config.apiRoot + this.postType + '-categories?per_page=99').then(function (response) {
		...
		setActive: function setActive(post, index) {
		...
		getSearchResults: function getSearchResults() {
			...
			if (this.taxonomyName.toLowerCase() == 'all') {
				...
				axios.get(_config.apiRoot + $this.postType + '?search=' + $this.searchText).then(function (response) {
					$this.searchPosts = response.data;
					$this.faqPosts = [];
				});
			} else {

				axios.get(_config.apiRoot + $this.postType + '?_embed&filter[' + $this.postType + '_taxonomies]=' + $this.taxonomyName.toLowerCase() + '&search=' + $this.searchText)
...
exports.default = {
	...
	methods: {
		getAllFAQs: function getAllFAQs() {
			...
			axios.get(_config.apiRoot + $this.postType + '?faq-categories=' + $this.termId + '&per_page=99').then(function (response) {
				$this.faqPosts = response.data;
			});
		},
		setActive: function setActive(post, index) {
...
exports.default = {
	...
	methods: {
		...
		changeSwatch: function changeSwatch(event) {
			...
			var newImage = event.target.dataset.image;
			var bgColor = event.target.style.backgroundColor;
			var $watches = $('.color-swatch');
		...
		getFilms: function getFilms() {
			...
			var energy = this.$options.filters.importance(this.energySavings);
			var glare = this.$options.filters.importance(this.glareReduction);
			var safety = this.$options.filters.importance(this.safetySecurity);
		...
		setModalContent: function setModalContent(postID) {
			var $this = this;
			axios.get(_config.apiRoot + 'residential/' + postID + '?_embed').then(function (response) {
				$this.modalTitle = response.data.title.rendered;
				$this.modalBody = response.data.content.rendered;
				$this.modalImage = response.data.acf.film_selector_product_image;
				$this.modalLogo = response.data.acf.film_selector_product_logo;
		...
		sendEmail: function sendEmail() {
			var link = "mailto:?subject=Madico%Film%20Selector%20Results" + "&body=" + document.getElementsByClassName("post-container")[0].innerText;
...
exports.default = {
	...
	methods: {
		createFormScript: function createFormScript() {
